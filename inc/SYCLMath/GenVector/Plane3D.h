...
// Last update: $Id$
//
#ifndef ROOT_Experimental_GenVector_Plane3D
#define ROOT_Experimental_GenVector_Plane3D  1

#include <type_traits>
#include "SYCLMath/GenVector/MathUtil.h"
#include "SYCLMath/GenVector/DisplacementVector3D.h"
#include "SYCLMath/GenVector/PositionVector3D.h"
...
public:
   ...
   */
   ...
   /**
    ...
    \param n normal expressed as a ROOT::Experimental::DisplacementVector3D<Cartesian3D<T> >
    \param p point  expressed as a  ROOT::Experimental::PositionVector3D<Cartesian3D<T> >
   */
   ...
   /**
    ...
    the plane)
    \param n normal expressed as a generic ROOT::Experimental::DisplacementVector3D
    \param p point  expressed as a generic ROOT::Experimental::PositionVector3D
   */
   ...
   /**
    ...
    \param p1 point1  expressed as a generic ROOT::Experimental::PositionVector3D
    \param p2 point2  expressed as a generic ROOT::Experimental::PositionVector3D
    \param p3 point3  expressed as a generic ROOT::Experimental::PositionVector3D
   */
   ...
   /**
    ...
    \param p1 point1 expressed as  ROOT::Experimental::DisplacementVector3D<Cartesian3D<T> >
    \param p2 point2 expressed as  ROOT::Experimental::DisplacementVector3D<Cartesian3D<T> >
    \param p3 point3 expressed as  ROOT::Experimental::DisplacementVector3D<Cartesian3D<T> >
   */
   ...
   */
   ...
   /**
    ...
    \param p Point expressed as generic ROOT::Experimental::PositionVector3D
    */
