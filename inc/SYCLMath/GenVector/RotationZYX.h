...
// Last update: $Id$
//
#ifndef ROOT_Experimental_GenVector_RotationZYX
#define ROOT_Experimental_GenVector_RotationZYX 1
...
/**
   ...
   This is  different than the convention of the ROOT::Experimental::EulerAngles class, where the rotation are
   intrinsic. Also it has not to be confused with the typical Goldstein definition of the Euler Angles (Z-X-Z or 313
   sequence) which is used by the ROOT::Experimental::EulerAngles class, while the sequence here is Z-Y-X or 321.
...
#endif // ROOT_Experimental_GenVector_RotationZYX
