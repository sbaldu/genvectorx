...
#ifndef ROOT_Experimental_GenVector_GenVector_exception
#define ROOT_Experimental_GenVector_GenVector_exception 1
...
// the interactive usage of entities such as ROOT::Experimental::PtEtaPhiMVector
