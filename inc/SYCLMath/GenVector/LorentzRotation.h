...
// Last update: $Id$
//
#ifndef ROOT_Experimental_GenVector_LorentzRotation
#define ROOT_Experimental_GenVector_LorentzRotation  1

#include "SYCLMath/GenVector/LorentzRotationfwd.h"
...
#endif /* ROOT_Experimental_GenVector_LorentzRotation  */
